...
const addUserToDatabase = async () => {
  ...
  try{
    ...
    let githubInformation = await axios.get("https://cors-anywhere.herokuapp.com/http://localhost:3000/api/auth/getGithubInfo", {timeout: 10000}).catch(err => {throw new error(err.name)});
